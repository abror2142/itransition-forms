 ...
 */
final class Version20250217134653 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD form_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_9474526C5FF69B7D');
        $this->addSql('ALTER TABLE comment DROP form_id');
    }
}
